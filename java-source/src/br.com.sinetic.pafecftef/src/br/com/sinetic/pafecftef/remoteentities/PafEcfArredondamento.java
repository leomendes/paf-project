...
/**
 * PafEcfArredondamento generated by hbm2java
 */
public class PafEcfArredondamento  implements java.io.Serializable {
    ...
    public PafEcfArredondamento() {
    }

	
    public PafEcfArredondamento(char sigla, String nome) {
        this.sigla = sigla;
        this.nome = nome;
    }
    public PafEcfArredondamento(char sigla, String nome, Set servicos, Set sineticControleEstoques) {
       this.sigla = sigla;
       this.nome = nome;
