 ...
 * @author Windows8
 */
public class UIAbreCaixa extends javax.swing.JDialog {

    private AAbreCaixa aAbreCaixa;
    
    /**
     * Creates new form UIAbreCaixa2
     */
    public UIAbreCaixa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public void setAction(AAbreCaixa a) {
        aAbreCaixa = a;
    }
    
    public void clearScreen(boolean selected, String screenName, String buttonName) {
        jftfValor.setText("R$ 0.00");
        this.setTitle(screenName);
        jbAbreCaixa.setText(buttonName);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Suprimento"));

        jLabel1.setText("Valor do Suprimento:");
    ...
    private void jbAbreCaixaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAbreCaixaActionPerformed
        ...
        try {
            fValor = Float.valueOf(sValue.replace(",", "."));
        }
        catch (Exception e) {
            fValor = 0;
        }

        if (aAbreCaixa.abreCaixa(fValor)) {
            aAbreCaixa.fecharTela();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UIAbreCaixa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UIAbreCaixa dialog = new UIAbreCaixa(new javax.swing.JFrame(), true);
